...
public class MedicamentoDao {
    ...
    private static final String INSERT = "INSERT INTO medicamentos (nombre, codigo_barras, foto, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE medicamentos SET nombre = ?, codigo_barras = ?, foto = ?, updated_at = ? WHERE id_medicamento = ?";
